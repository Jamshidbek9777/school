...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Us | DeutschSmart</title>
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
        ...
        {/* <section className="py-24">
          <Wrapper>
            ...
            <div className="relative">
              <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 h-full w-px bg-gradient-to-b from-yellow-500 to-red-600"></div>
              <div className="md:hidden absolute left-3 h-full w-1 bg-gradient-to-b from-yellow-500 to-red-600"></div>
              ...
              <div className="space-y-8">
                {journeys.map((item, idx) => (
                  ...
                  >
                    <div className="md:hidden flex-shrink-0 ml-[2px]  mt-2 w-6 h-6 rounded-full bg-yellow-500 border-2 border-white shadow"></div>
                    ...
                    <div className="hidden md:block  absolute left-1/2 transform -translate-x-1/2 w-12 h-12 rounded-full bg-white border-4 border-yellow-500 z-10"></div>
